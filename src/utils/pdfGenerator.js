  ...
  autoTable(doc, {
    ...
    body: [
      ...
      [{ content: "Teléfonos",            styles: { fontStyle: "bold", fillColor: C.header } }, (p.telefonos || []).join(", ") || "N/A",
       { content: "Celular / Móvil",      styles: { fontStyle: "bold", fillColor: C.header } }, v(p.celular)],
      [{ content: "Correo Electrónico",   styles: { fontStyle: "bold", fillColor: C.header } }, { content: v(p.correoElectronico), colSpan: 3 }],
