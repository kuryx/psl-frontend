...
export default function EditEvaluation() {
  ...
  useEffect(() => {
    const cargarEvaluacion = async () => {
      try {
        ...
        setForm({
          informacionDictamen: data.informacionDictamen || form.informacionDictamen,
          entidadCalificadora: data.entidadCalificadora || form.entidadCalificadora,
          paciente: {
            ...form.paciente,
            ...data.paciente,
            telefonos: data.paciente?.telefonos?.length > 0 ? data.paciente.telefonos : [""],
          },
          antecedentesLaborales: data.antecedentesLaborales || form.antecedentesLaborales,
          historialClinico: data.historialClinico || "",
          diagnosticoPrincipal: data.diagnosticoPrincipal || null,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await actualizarEvaluacion(id, datosEvaluacion);
      ...
      <Paper elevation={3} sx={{ mt: 4, p: 4, mb: 4 }}>
        ...
        {success && (
          <Alert severity="success" sx={{ mb: 2 }}>
            Evaluación actualizada correctamente. Redirigiendo...
          </Alert>
        )}
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          <Alert severity="info" sx={{ mt: 2, mb: 2 }}>
            📝 Editando evaluación existente - Los cambios se guardarán al hacer clic en "Guardar Cambios"
          </Alert>
